...
public class ResultGeneratorTest {
   ...
   public void setUp(){
    ...
    /**
     * Tests an invalid Result Object for add command. The
    ...
    /**
     * Tests generic deleteAll, asks the user for confirmation. Reset is not tested because it is the exact same implementation
     */
    ...
    public void test_Display_20_Tasks() {
        ...
        for(int index = 0; index < 10; index++){
            ...
            outputsDisplayTest.add(new TaskStub("empty", new DateTimeStub("08/11/2014", "1200"),
