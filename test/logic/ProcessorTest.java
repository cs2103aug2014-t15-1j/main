...
public class ProcessorTest {
	...
	private Task testTask1 = new Task("Do CS2103 Homework", null, null, null, new ArrayList<String>());
	private Task testTask2 = new Task("Do EE2020 Homework", null, null, null, new ArrayList<String>());
	...
	public void testAdd() throws Exception {
		...
		assertTrue(equalsObj(testTask1, r3.getTasks().get(0)));
	}
